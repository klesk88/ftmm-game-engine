...
FourDirectionsMovement_InputWord::FourDirectionsMovement_InputWord(int count_gameStates) : InputWord(count_gameStates)
{
	x_velocity = 0;
	y_velocity = 0;
...
InputEvent* FourDirectionsMovement_InputWord::update(SDL_Event _event)
{
